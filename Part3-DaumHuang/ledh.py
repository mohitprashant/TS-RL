...
class LEDHFilter(ParticleFlow):
    """
    Deterministic Localized Exact Daum-Huang Filter.
    """
    ...
    def run_step(self, particles, m_ekf, P_ekf, y_curr):
        """
        Executes one time step of the LEDH filter.
        ...
        for i in range(self.steps):
            ...
            # Local linearization: x_lin = particles
            A, b, cond = self.compute_Ab_and_cond(P_pred, y_curr, particles, lam)
            total_cond += cond
